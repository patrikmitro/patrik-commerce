            ...
            <div class="col-lg-6 col-md-6">
                <nav class="header__menu mobile-menu">
                    <ul>
                        ...
                        <li class="{{ request()->is('shop/*') ? 'active' : null }}"><a href="{{ route('product.index') }}">Shop</a></li>
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
            ...
            <div class="col-lg-3 col-md-3">
                <div class="header__nav__option">
                    ...
                    <a href="{{ route('cart.index') }}"><img src="{{ asset('img/icon/cart.png') }}" alt="">
                        @if(session('cart'))
                            <span>{{ Helper::cartQuantity() }}</span>
                        @else
                            <span>0</span>
                        @endif
                    </a>
                    <div class="price">${{ Helper::cartTotal(session('cart')) }}</div>
                </div>
            </div>
        </div>
